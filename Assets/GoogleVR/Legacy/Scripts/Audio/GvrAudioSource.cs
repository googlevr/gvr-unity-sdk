//-----------------------------------------------------------------------
// <copyright file="GvrAudioSource.cs" company="Google Inc.">
            ...
            if (audioSource != null)
            {
                ...
                if (rolloffMode == AudioRolloffMode.Custom)
                {
                    ...
                    audioSource.SetCustomCurve(AudioSourceCurveType.CustomRolloff,
                        AnimationCurve.Linear(sourceMinDistance, 1.0f, sourceMaxDistance, 1.0f));
                }
            }
        }
    }
